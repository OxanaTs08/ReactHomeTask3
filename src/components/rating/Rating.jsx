...
function Rating() {
    ...
    return(
        <div style={styles.div}>
         <>
            <button className="button"  onClick={() => oneRatingList(0)}>
                Плохо
            </button>

            <button className="button" onClick={() => oneRatingList(1)}>
                Хорошо
            </button>

            <button className="button" onClick={() => oneRatingList(2)}>
                Отлично
            </button>

            <button className="button" onClick={() => oneRatingList(3)}>
                Супер
            </button>
          </>
